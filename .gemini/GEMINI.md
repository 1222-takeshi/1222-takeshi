...
6. **その他のルール**
    ...
    *  IssueベースのPRをマージしたらIssueは閉じるようにしてください。この際、TODOを確認してIssueの課題が解決しているか確認してください。チェックボックスのちゃんとチェック入れるようにしてください。
    *  作業の計画とログを.gemini_memory_<y/m/d>.mdにまとめるようにしてください。私が「今日の作業は終了します。」と言ったらサマリーをまとめてください。別日にgeminiに見せた時に仕事ができるようにまとめてください。
    *  仕事の始めに.gemini_memory_<t/m/d>.mdを確認して仕事に内容を思い出してください。
    *  force pushは基本NG
